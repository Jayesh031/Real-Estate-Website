...
export default function Projects(){
    ...
    const [cardsToShow,setCardsToShow] = useState(1); {/*Atleast show one card*/}
    ...
    const nextProject = () =>{
        setCurrentIndex((prevIndex) => (prevIndex + 1) % projectsData.length);  //inorder to go to first project
    }
